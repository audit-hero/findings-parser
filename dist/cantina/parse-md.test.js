...
`;
    let fixed = fixLineBreaks(pg);
    expect(fixed).toBe("Only withdrawal transactions will be able to exploit this issue.*\n\n**Proof of concept:** The issue lies in the getSpentStakingTx.");
});
